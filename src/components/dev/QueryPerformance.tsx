...
export const QueryPerformance: React.FC = () => {
    ...
    return (
        <div className="hidden lg:block fixed bottom-4 left-4 z-50 bg-black/80 text-white p-4 rounded-lg border border-gray-700 text-xs font-mono shadow-xl max-w-xs opacity-50 hover:opacity-100 transition-opacity">
